...
//	private Tool tool;
	...
	public void initialize() {
        ...
        ObjectFrame aTransformation = _toolAttachedToLBR1.addChildFrame(TOOL_FRAME1
                + "(TCP)", trans);
	...
	public HandGuidingMotion createhandGuidingMotion(){
		...
		.setJointLimitsEnabled(false,false,false,false,false,false,false)
...
//				 _toolAttachedToLBR1.moveAsync(aSmartServoLINMotion);
...
//						Frame Ptest2 = destFrame.transform((Transformation.ofRad(dfx, dfy, dfz, dfa, dfb, dfc)));
						Frame Ptest2 = destFrame.transform((Transformation.ofRad(dfx*2, 0, dfz*2, 0, 0, 0)));

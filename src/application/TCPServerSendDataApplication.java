...
public HandGuidingMotion createhandGuidingMotion(){
		...
		.setJointLimitsMax(Math.toRadians(10), Math.toRadians(30), Math.toRadians(45), Math.toRadians(100), Math.toRadians(65),Math.toRadians(-40), Math.toRadians(165))
		.setJointLimitsMin(Math.toRadians(-10), Math.toRadians(-14), Math.toRadians(-45), Math.toRadians(0), Math.toRadians(-65),Math.toRadians(-100), Math.toRadians(-165))
...
//					System.out.println("Object22"+Object2);
					...
					Frame Object4 = Object2.transform((Transformation.ofDeg(0,0,0, -35, 0, -90)));
...
//					System.out.println("Ptest8");
					...
					Frame Ptest2 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(50, -150, -150)));
					
					
					Frame Ptest3 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(50, 0, -150)));
					Frame Ptest4 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(50, -300, -150)));
					
					Frame Ptest5 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(50,-150,-300)));
					Frame Ptest6 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(50, -150, 0)));
					
					Frame Ptest7 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(100, -150, -150)));
					Frame Ptest8 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(0, -150, -150)));
...
//					System.out.println("Ptest9");
					...
					Frame Ptest3 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(100, 0, 0)));
					Frame Ptest4 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(100, 0, -100)));
					
					Frame Ptest5 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(0,-100,0)));
					Frame Ptest6 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(0, -100, -100)));
					
					Frame Ptest7 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(100, -100, 0)));
					Frame Ptest8 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(100, -100, -100)));
					
					Frame Ptest9 = getApplicationData().getFrame("/P6").copyWithRedundancy().transform((Transformation.ofTranslation(50, -50, -50)));
					
					//ThreadUtil.milliSleep(5000);//frequency of recording
					needle.getFrame("/tcp_3").move(ptp(Ptest1).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest1");
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest2).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest2");
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest3).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest3");
					System.out.println("Ptest3"+Ptest3);
					ThreadUtil.milliSleep(20000);
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest4).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest4");
					System.out.println("Ptest4"+Ptest4);
					ThreadUtil.milliSleep(20000);
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest5).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest5");
					System.out.println("Ptest5"+Ptest5);
					ThreadUtil.milliSleep(20000);
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest6).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest6");
					System.out.println("Ptest6"+Ptest6);
					ThreadUtil.milliSleep(20000);
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest7).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest7");
					System.out.println("Ptest7"+Ptest7);
					ThreadUtil.milliSleep(20000);
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest8).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest8");
					System.out.println("Ptest8"+Ptest8);
					ThreadUtil.milliSleep(20000);
					...
					System.out.println("Ptest1"+Ptest1);
					ThreadUtil.milliSleep(20000);
					needle.getFrame("/tcp_3").move(ptp(Ptest9).setBlendingCart(0).setJointVelocityRel(0.2).setBlendingRel(0).setBlendingRel(0));
					System.out.println("Ptest9");
					System.out.println("Ptest9"+Ptest9);
					ThreadUtil.milliSleep(20000);

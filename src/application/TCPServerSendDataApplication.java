...
public HandGuidingMotion createhandGuidingMotion(){
		...
		.setJointLimitsMax(Math.toRadians(10), Math.toRadians(0), Math.toRadians(45), Math.toRadians(115), Math.toRadians(160),Math.toRadians(-45), Math.toRadians(165))
		.setJointLimitsMin(Math.toRadians(-10), Math.toRadians(-46), Math.toRadians(-45), Math.toRadians(0), Math.toRadians(-160),Math.toRadians(-110), Math.toRadians(-165))

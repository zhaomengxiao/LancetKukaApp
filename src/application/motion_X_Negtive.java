 ...
 * 
 */
public class motion_X_Negtive extends RoboticsAPIApplication
{
	@Inject
    ...
    public void initialize()
    {
        ...
        _toolAttachedToLBR = new Tool("Tool_ForPlane3", _loadData);
...
//	    	 _lbr.move(ptp(Ptest1).setJointVelocityRel(0.2));
    ...
    public static void main()
    {
        ...
        final motion_X_Negtive app = new motion_X_Negtive();
        app.runApplication();
    }
}
